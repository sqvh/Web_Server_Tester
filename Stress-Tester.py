...
"""
# Exploit Title  : [WEB-SERVER_TEST.py 1.0 http/s DDOS Script]
# Exploit Author : [sqvh]
# Contacts       : [discord: sqvh#5615]
# Software Link  : [ https://workupload.com/file/Q2vGF7GYVdt ]
# Version        : [1.0] 
...
GOLDENEYE_BANNER = 'TESTING SERVER WITH HTTP-REQUESTS - made by sqvh || sqvh#5615'
...
class GoldenEye(object):
    ...
    def exit(self):
        self.stats()
        print "Shutting down Stress-Testing Attack."
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print "{0} Stress-Testing strikes deferred. ({1} Failed)".format(self.counter[0], self.counter[1])
...
def usage():
    ...
    print GOLDENEYE_BANNER
    print 
    print ' USAGE: python WEB-SERVER_TESTING.py <url> [OPTIONS]'
    print
    print ' OPTIONS:'
